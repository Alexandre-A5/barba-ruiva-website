...
function RadioModel({ url, rotation, color }) {
  ...
  return <primitive ref={ref} object={model} scale={2} />;
}
  ...
  return (
    <div className={className}>
      <Canvas shadows>
        ...
        <Suspense>
          <RadioModel url="/models/radio/radio.gltf" rotation={rotation} color={color} />
        </Suspense>
